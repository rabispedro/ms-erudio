...
namespace GeekShopping.OrderAPI.Migrations
{
    ...
    [Migration("20240129201022_Create_Default_Order_Tables")]
    partial class CreateDefaultOrderTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GeekShopping.OrderAPI.Models.OrderHeader", b =>
                {
                    ...
                    b.ToTable("tbl_order_header");
                });

            modelBuilder.Entity("GeekShopping.OrderDetailAPI.Models.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
